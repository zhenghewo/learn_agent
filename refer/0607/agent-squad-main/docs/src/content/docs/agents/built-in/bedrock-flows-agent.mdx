...
- [TypeScript Sample](https://github.com/2fastlabs/agent-squad/tree/main/examples/bedrock-flows/typescript)
- [Python Sample](https://github.com/2fastlabs/agent-squad/tree/main/examples/bedrock-flows/python)
