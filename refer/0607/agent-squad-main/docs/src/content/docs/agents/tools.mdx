...
To continue learning about AgentTools in the Agent Squad System, head over to our [examples](https://github.com/2fastlabs/agent-squad/tree/main/examples/tools) in Github
